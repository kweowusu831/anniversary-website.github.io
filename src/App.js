...
const AnniversaryCalendar = () => {
  ...
  const days = [
    ...
    { day: 7, date: "January 7th", title: "How You Love Me", subtitle: "The Ways I Feel It", icon: Heart, bgColor: "#faf0e6", imageUrl: "/Photos/Collage/image198.jpeg", content: { 
      message: "The way you love me is special, not because of how we show affection or because you are willing to pay for dates or buy me gifts. It is special because your love lives in your actions. The way you show up every day reflects what this relationship is meant to be, a true partnership built on care, effort, and intention. I have my own love language, and I know words do not always come easily to you, but your actions speak louder than anything else ever could. Your love listens. Your love pays attention. Your love moves with patience and purpose.\n\nI will never forget how much effort you put into making my 20th birthday meaningful when you came with me to New Jersey. You did not just show up for me, you showed up for my family. You helped without being asked, supported where you could, and carried yourself with so much care and respect. What touched me most was the way you paid attention to the little things that mattered to me. You made my favorite dessert just so I could feel celebrated and loved. Even when your car got towed, something that would have completely ruined the day for most people, you never let it take away from my happiness. You stayed present, calm, and focused on making sure I still felt special. That moment showed me your selfless heart and the depth of your love in a way I will never forget.\n\nWatching you move through that day made me love and admire you even more. You went above and beyond simply because you care about me, and that kind of love is rare. It is the kind of love that stays, that builds, and that lasts.", 
      note: "Then there was my 21st birthday, a moment when I felt hurt, disappointed, and alone. I did not know how to ask for comfort, but somehow, you understood exactly what I needed. You worked quietly to bring my friends together just so I could feel loved and celebrated. That night became one of the most meaningful experiences of my life, not because of what we did, but because of what it represented. You saw me in a moment when I felt invisible, and you chose to show up for me anyway. That is something I will carry with me forever.\n\nThank you, Sandrine, for being the love I needed when I did not know how to ask for it. You are truly one of a kind. Your love makes me feel seen in a world where I once felt disconnected from myself. You have healed parts of me that I did not even realize were hurting, and through your love, I have grown into a better man. You inspire me not only to work harder for our relationship, but to work harder for myself as well.\n\nThank you for being my steady presence, my safe place, and my light on days when things feel heavy. Loving you has changed me in the most beautiful way, and being loved by you is something I will never take for granted. The way you love me has reshaped my heart, and I am endlessly grateful for you so, to show my gratitude, let me be of service to you.", 
      extraPhotos: [
        "/Photos/Collage/image188.jpeg",
        "/Photos/Collage/image189.jpeg",
        "/Photos/Collage/image190.jpeg",
        "/Photos/Collage/image191.jpeg",
        "/Photos/Collage/image192.jpeg",
        "/Photos/Collage/image193.jpeg",
        "/Photos/Collage/image194.jpeg",
        "/Photos/Collage/image195.jpeg",
        "/Photos/Collage/image196.jpeg",
        "/Photos/Collage/image197.jpeg",
        "/Photos/Collage/image199.jpeg",
        "/Photos/Collage/image200.jpeg",
          ...
          <div className="p-8">
            ...
            <div id="response-section" style={{marginTop: '30px', padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px', border: '2px solid #ff69b4'}}>
              ...
              <p style={{color: '#666', fontSize: '0.95rem', marginBottom: '15px'}}>
                {day.content.hasAgreement 
                  ? "Please share any additional rules or things you'd like us to work on, along with your thoughts about this day..."
                  : "Share your thoughts about this day..."}
              </p>
              <textarea
                value={responseText}
                onChange={(e) => setResponseText(e.target.value)}
                placeholder={day.content.hasAgreement 
                  ? "Share additional rules you'd like to add, or your thoughts on these rules..."
